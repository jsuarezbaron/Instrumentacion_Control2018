...
def playrec_tone(frecuencia, duracion, amplitud=0.5, fs=2000):
    """
    ...
    print("La grabacion es: ",grabacion)
    plt.subplot(2,1,2)
    plt.plot(grabacion, 'b.--')
    #plt.show()  #no sirvio para para sacar las graficas de la terminal
...
def frequency_response(points, freqstart = 400, freqend = 450, duracion = 1):
    """
